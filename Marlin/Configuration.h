...
#define MACHINE_UUID "05f493af-a2a4-4760-850c-849bdfb45878"
 ...
 */
#define TEMP_SENSOR_0 1047 // 4k7 pullup resistor on board
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define MIN_BED_POWER 15
  //#define PID_BED_DEBUG // Sends debug data to the serial port.

  //120V 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
  //from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
  #define DEFAULT_bedKp 33.89
  #define DEFAULT_bedKi 1.13
  #define DEFAULT_bedKd 675.52
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 250, 250, 2000, 25 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2500, 2500, 250, 5000 }
...
//
// https://3dprinting.stackexchange.com/questions/5857/z-offset-on-autoleveling-sensor-setup
/**
